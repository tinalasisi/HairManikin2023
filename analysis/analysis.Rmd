...
df_long_wetdry_final %>% 
  filter(wig == "Nude" & wind == 0.3 & wet_dry=="dry" & var =="on")
...
When the hair is sweaty, having hair would decrease solar influx. Having mid-curvature hair will decrease more solar influx than straight hair and curliest hair do.
```{r lm-wet-influx}
