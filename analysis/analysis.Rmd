...
```{r General-Plots, echo=FALSE, fig.height=5, fig.width=8}
...
```{r General-After-Outlier-Removal, fig.height=5, fig.width=8}
df_wetdry_plots <- df_wetdry %>% 
  unite('data_points', c('radiation','trial'), remove=FALSE)
...
# unscaled 
manuscript_plt_dry_lm <- plot_summs(model_dry_off, model_dry_on, model_dry,  model.names = c("Radiation Off", "Radiation On", "Solar Influx"))
