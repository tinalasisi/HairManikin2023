...
sweat_zero_plot_panel <- sweat_zero_plot + theme(legend.position = "none")

sweat_max_plot_panel <- sweat_max_plot + theme(axis.title.y = element_blank())

grid.arrange(sweat_zero_plot_panel, sweat_max_plot_panel, nrow=1)
