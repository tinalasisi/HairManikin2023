...
manuscript_plt6 <- (manuscript_plt_dry_lm + theme(axis.text.y = element_blank())+ (manuscript_plt_wet_lm)) + plot_layout(guides = "collect")
...
left_plts <- manuscript_plt1 / manuscript_plt6 + plot_layout(guides = "auto", heights = c(1.5,1))

right_plts <- (manuscript_plt2 / manuscript_plt3 / manuscript_plt4 + plot_layout(guides = "collect"))

  patchwork <- left_plts | right_plts + plot_layout(widths = c(1.5, 1))
...
pltsave_func(manuscript_combo_fig, plot_path, width = 13, height = 7)
